...
def manage_students():
    ...
    named_students = ['Shakiera', 'Mica', 'Kaya', 'Arash']
    first_student = named_students[1]
    last_student = named_students[-1]
...
def combine_foods():
    ...
    foods = ('pizza', 'pasta', 'salad', 'sandwich')
    meal = ''
    for food in foods:
        meal += food + ', '
    return meal
...
def create_awesome_students():
    ...
    students = ['Shakiera', 'Mica', 'Kaya', 'Arash']
...
def filter_foods_with_a():
    ...
    foods_with_a = [food for food in ('fries', 'popcorn', 'salad', 'sandwich') if 'a' in food]
    return foods_with_a
